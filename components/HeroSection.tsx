...
export default function HeroSection() {
  return (
    <section id="hero" className="relative w-full min-h-screen flex flex-col justify-center px-4 sm:px-6 md:px-12 lg:px-20 xl:px-28 py-20 sm:py-24 md:py-32">
      <div className="grid-bg fixed inset-0 -z-10" aria-hidden="true" />
      <div className="max-w-7xl mx-auto w-full flex flex-col gap-8 sm:gap-10 md:gap-12">
        <div className="text-orange-500 h-6 sm:h-7 md:h-8">
          <SplitFlapText text={GREETING} />
        </div>
        <div className="max-w-4xl">
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-[var(--font-bebas)] text-neutral-950 dark:text-neutral-50 tracking-tight leading-tight">
            {HEADLINE}
          </h1>
        </div>
        <p className="font-mono text-xs sm:text-sm md:text-base text-neutral-600 dark:text-neutral-400 max-w-2xl leading-relaxed">
          {DESCRIPTION}
        </p>
